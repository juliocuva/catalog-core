    ...
    <div className="bg-background min-h-screen pb-24 font-sans text-foreground w-full relative">
      ...
      {isLoginModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/20 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="w-full max-w-[420px] rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 relative bg-gradient-to-br from-white via-teal-50/30 to-teal-100/50">
            
            {/* Close Button */}
            <button onClick={() => setIsLoginModalOpen(false)} className="absolute top-4 right-4 text-gray-400 hover:text-gray-600 z-10 p-2">
            ...
            <div className="px-10 pt-12 pb-10">
              ...
              <div className="flex flex-col items-center mb-8 relative">
                {/* Decorative Line & Dot */}
                <div className="absolute -top-16 left-1/2 -translate-x-1/2 w-[1px] h-16 bg-teal-800/20"></div>
                <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-2.5 h-2.5 rounded-full bg-teal-800"></div>
                
                <h2 className="text-[3.5rem] font-light text-[#0A5C53] leading-none mb-4 font-serif tracking-tight">Access</h2>
                <div className="text-[10px] font-bold text-[#0A5C53] tracking-[0.3em] uppercase">
                  Master Terminal
                </div>
              </div>

              <div className="text-center text-sm text-gray-500 mb-6 font-medium">
                Don't have an account? <span className="text-[#0A5C53] font-bold cursor-pointer hover:underline">Sign up</span>
              </div>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full text-sm border border-gray-200/60 bg-white/60 rounded-xl px-4 py-3.5 focus:outline-none focus:border-[#0A5C53] focus:ring-1 focus:ring-[#0A5C53] transition-all placeholder:text-gray-400" 
                  />
                </div>
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full text-sm border border-gray-200/60 bg-white/60 rounded-xl px-4 py-3.5 pr-12 focus:outline-none focus:border-[#0A5C53] focus:ring-1 focus:ring-[#0A5C53] transition-all placeholder:text-gray-400" 
                  />
                ...
                <div className="flex justify-between items-center px-1 pt-1 mb-2">
                  <label className="flex items-center gap-2 cursor-pointer group">
                    <div className="w-4 h-4 rounded border border-gray-300 bg-white flex items-center justify-center group-hover:border-[#0A5C53] transition-colors">
                      <svg className="w-3 h-3 text-transparent group-hover:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" /></svg>
                    </div>
                    <span className="text-xs text-gray-500 font-medium">Remember me</span>
                  </label>
                  <a href="#" className="text-xs font-bold text-[#0A5C53] hover:underline">
                    Forgot password?
                  </a>
                </div>

                {/* Submit Button */}
                <button type="submit" disabled={isUploading} className="w-full bg-[#036053] text-white font-semibold text-[15px] py-3.5 rounded-xl hover:bg-[#024a40] transition-colors mt-2 disabled:opacity-70 shadow-lg shadow-[#036053]/20">
                  {isUploading ? 'Verificando...' : 'Enter System'}
                </button>
              </form>
              ...
              <div className="flex items-center gap-3 my-6">
                ...
                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Or log in with</span>
                <div className="flex-1 h-px bg-gray-200"></div>
              </div>

              {/* Google Button */}
              <button type="button" className="w-full bg-white border border-gray-200 text-gray-600 font-medium text-sm py-3.5 rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center gap-3">
          ...
          <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
            ...
            <div className="p-6 overflow-y-auto">
              <div className="bg-brand-primary/5 text-brand-primary p-4 rounded-xl mb-6">
                <p className="text-sm">La gestión de usuarios y roles está integrada directamente en el panel administrativo principal.</p>
                <a href="/admin/collections/users" className="mt-3 w-full block text-center bg-brand-primary text-white text-sm font-bold py-2.5 rounded-lg hover:bg-blue-700 transition-colors">
